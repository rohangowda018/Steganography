...
def Decode():
    Screen.destroy()
    DecScreen = Tk()
    DecScreen.title("Decode- RohanGowda")
    DecScreen.geometry("500x500+300+300")
    DecScreen.config(bg="orange")
    def OpenFile():
        global FileOpen
        FileOpen=StringVar()
...
def Encode():
    Screen.destroy()
    EncScreen = Tk()
    EncScreen.title("Encode- RohanGowda")
    EncScreen.geometry("500x500+300+300")
    EncScreen.config(bg="light blue")
...
Screen = Tk()
Screen.title("Image Steganography by - RohanGowda ")
